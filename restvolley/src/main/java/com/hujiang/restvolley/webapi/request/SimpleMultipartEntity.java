...
class SimpleMultipartEntity implements HttpEntity {
    ...
    public void addPart(String key, String streamName, InputStream inputStream, String type)
        ...
        // Stream (file)
        final byte[] tmp = new byte[STREAM_BUFFER_SIZE];
        int l;
    ...
    private String normalizeContentType(String type) {
        return type == null ? RestVolley.APPLICATION_OCTET_STREAM : type;
    }
    ...
    private byte[] createContentDisposition(String key) {
        return (
                RestVolley.HEADER_CONTENT_DISPOSITION + ": form-data; name=\"" + key + "\"" + STR_CR_LF).getBytes();
    }

    private byte[] createContentDisposition(String key, String fileName) {
        return (
                RestVolley.HEADER_CONTENT_DISPOSITION + ": form-data; name=\"" + key + "\"" + "; filename=\"" + fileName + "\"" + STR_CR_LF).getBytes();
    }
    ...
    public Header getContentType() {
        return new BasicHeader(RestVolley.HEADER_CONTENT_TYPE, "multipart/form-data; boundary=" + boundary);
    }
