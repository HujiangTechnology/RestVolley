...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final Header HEADER_JSON_CONTENT = new BasicHeader(HTTP.CONTENT_TYPE, RestVolley.APPLICATION_JSON);
    private static final Header HEADER_GZIP_ENCODING = new BasicHeader(HTTP.CONTENT_ENCODING, RestVolley.ENCODING_GZIP);
    ...
    /**
     * constructor.
     * @param useGZipCompression use GZip compression or not.
     * @param elapsedField elapsed field.
     */
            ...
            switch (ch) {
                ...
                default:
                    ...
                    if ((ch <= '\u001F') || (ch >= '\u007F' && ch <= '\u009F') || (ch >= '\u2000' && ch <= '\u20FF')) {
                        ...
                        sb.append("\\u");
                        int intLength = UNICODE_CHAR_SIZE - intString.length();
    ...
    private void writeToJsonStream(OutputStream os, Object value) throws IOException {
