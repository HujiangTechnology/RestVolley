...
public class ImageLoaderGlobalConfig {
    ...
    /**
     * set memory cache size for {@link RVImageLoader}.
    ...
    /**
     * set disk cache size for {@link RVImageLoader}.
    ...
    /**
     * set disk cache dir for {@link RVImageLoader}.
     ...
     * you can create instance of new {@link RequestEngine} with {@link com.hujiang.restvolley2.RestVolley#newRequestEngine(Context, String)}<br>
     * default is {@link com.hujiang.restvolley2.RestVolley#newRequestEngine(Context, String)}
     * with tag {@link com.hujiang.restvolley2.RestVolley#TAG_REQUEST_ENGINE_DEFAULT}.
