 ...
 */
public class RVRequestWithBody<R extends RVRequest> extends RVRequest<R> {
    /**
     * stream params map.
     */
     ...
     * @param method method.
     */
    public RVRequestWithBody(Context context, int method) {
