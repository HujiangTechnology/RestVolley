...
import com.hujiang.restvolley2.webapi.request.GetRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_office_ca).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new GetRequest(HTTPSActivity.this).url("https://pass.hjapi.com/v1.1").execute(new RVCallback<String>() {
                    @Override
        ...
        findViewById(R.id.btn_self_ca).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new GetRequest(HTTPSActivity.this).url("https://app.m.hjfile.cn/android/appsbar/").execute(new RVCallback<String>() {
                    @Override
                    public void onSuccess(int statusCode, String data, Map<String, String> headers, boolean notModified, long networkTimeMs, String message) {
                        mRequestContentView.setText(statusCode + "===>" + data + "===>" + message);
                    }
        ...
        findViewById(R.id.btn_no_ca).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new GetRequest(HTTPSActivity.this).url("http://api.mobile.hujiang.com/mobileapp/appUpmobile.ashx").execute(new RVCallback<String>() {
                    @Override
                    public void onSuccess(int statusCode, String data, Map<String, String> headers, boolean notModified, long networkTimeMs, String message) {
                        mRequestContentView.setText(statusCode + "===>" + data + "===>" + message);
                    }
